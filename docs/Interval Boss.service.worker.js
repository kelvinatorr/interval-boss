...
const CACHE_NAME = "Interval Boss-cache";
const OFFLINE_URL = "Interval Boss.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Interval Boss.html","Interval Boss.js","Interval Boss.wasm","Interval Boss.pck","Interval Boss.offline.html","Interval Boss.icon.png","Interval Boss.apple-touch-icon.png"];
